...
2. **Anchor the scores — no vibes.** Each policy starts at 100 and deducts per issue: critical −30, high −15, medium −8, low −3. A reviewer that deviates states why in `reason`. The schedule makes ≥ 80 mean something concrete: no critical/high issue, at most minor nits.
